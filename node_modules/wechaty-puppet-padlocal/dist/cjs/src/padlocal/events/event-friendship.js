...
const isReceive = async (message) => {
    if (message.type !== types_js_1.WechatMessageType.VerifyMsg && message.type !== types_js_1.WechatMessageType.VerifyMsgEnterprise) {
        return null;
    }
    try {
        ...
        else if ((0, is_type_js_1.isIMContactId)(contactId)) {
            return verifyXml;
        }
    }
    catch (e) {
