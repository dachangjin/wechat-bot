...
async function roomMessageSentByOthers(padLocalMessage, ret) {
    if ((0, is_type_js_1.isRoomId)(padLocalMessage.fromusername) || (0, is_type_js_1.isIMRoomId)(padLocalMessage.fromusername)) {
...
async function roomMessageSentBySelf(padLocalMessage, ret) {
    if ((0, is_type_js_1.isRoomId)(padLocalMessage.tousername) || (0, is_type_js_1.isIMRoomId)(padLocalMessage.tousername)) {
 ...
 * @param context
 */
const roomParser = async (padLocalMessage, ret, context) => {
